...
android {
    ...
    val apiBaseUrl = (project.findProperty("API_BASE_URL") as String?) ?: "http://bashbosh.ru"
    val wsBaseUrl = (project.findProperty("WS_BASE_URL") as String?) ?: "ws://bashbosh.ru"
    val apiFallbackUrl = (project.findProperty("API_FALLBACK_URL") as String?) ?: "http://10.0.2.2:8000"
    val wsFallbackUrl = (project.findProperty("WS_FALLBACK_URL") as String?) ?: "ws://10.0.2.2:8000"
