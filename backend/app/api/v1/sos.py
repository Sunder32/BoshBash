...
async def create_alert(
    ...
    if alert_data.description:
        try:
            ...
            advice_data = {
                ...
                "safety_tips": advice_result.get("safety_tips", [])
            }
        except Exception as e:
            print(f"Ошибка анализа описания: {e}")
    ...
    new_alert = SOSAlert(
        ...
        ai_analysis=advice_data  # Сохраняем советы
    )
...
async def analyze_description(
    ...
    Возвращает советы и рекомендации по действиям
    """
    try:
        result = keyword_advisor.analyze(description)
        return result
    except Exception as e:
        raise HTTPException(
